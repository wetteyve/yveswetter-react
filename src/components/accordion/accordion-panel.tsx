  ...
  return (
    <>
      <div
        ...
        className={`bg-white flex cursor-pointer items-center justify-between outline-none transition-all duration-300 hover:bg-primary-light ${
          props.open ? 'py-8' : 'py-6'
        }`}
      >
        <h3 className='block overflow-hidden text-ellipsis whitespace-nowrap'>{props.title}</h3>
