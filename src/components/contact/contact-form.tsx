...
const ContactForm = () => {
  ...
  const MAIL_CLIENT_URL = 'https:///mailer.yveswetter.ch/mailer/contact-form?mailClient=yves';
  ...
  return (
    <div ref={formRef} data-origin='bottom' className='container mt-5 fadeInFromBottom'>
      <form onSubmit={onSubmit}>
        ...
        <button
          ...
          className={`btn btn-danger my-6 py-2 px-4 shadow-md text-white rounded-md
                      ...
                      ${formStatus === 'Send' ? 'bg-[#4CAF50] hover:scale-105 ' : 'bg-[#FF5252]'}`}
          type='submit'
        >
          {formStatus}
        </button>
